...
public class GameFileSystemDPPt extends GameFileSystem {
    ...
    public GameFileSystemDPPt() {
        areaDataPath = getPath(new String[]{"files", "fielddata", "areadata", "area_data.narc"});
        areaBuildModelPath = getPath(new String[]{"files", "fielddata", "areadata", "area_build_model", "area_build.narc"});
        areaBuildTilesetPath = getPath(new String[]{"files", "fielddata", "areadata", "area_build_model", "areabm_texset.narc"});
        buildModelPath = getPath(new String[]{"files", "fielddata", "build_model", "build_model.narc"});
        buildModelMatshpPath = getPath(new String[]{"files", "fielddata", "build_model", "build_model_matshp.dat"});
        buildModelAnimePath = getPath(new String[]{"files", "arc", "bm_anime.narc"});
        buildModelAnimeListPath = getPath(new String[]{"files", "arc", "bm_anime_list.narc"});
    }
