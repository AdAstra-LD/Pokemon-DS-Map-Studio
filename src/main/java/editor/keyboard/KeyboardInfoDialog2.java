                ...
                //======== jScrollPane2 ========
                {
                    ...
                    jList2.setModel(new AbstractListModel<String>() {
                        String[] values = {
                            ...
                            "M - Enable / disable rectangle selection mode",
                            "CTRL + A - Select whole map",
                            "CTRL + C - Copy selected region",
                            "CTRL + X - Cut selected region",
                            "CTRL + V - Paste region (left click to stamp, right click / ESC to stop)",
                            "CTRL + F - Fill selected region with the selected tile",
                            "DELETE - Delete tiles in the selected region",
                            "CTRL + D - Deselect",
                            "ESC - Cancel move / paste, clear selection",
                            "Single click (rectangle select) - Deselect",
                            "RIGHT CLICK on selection - Actions menu (move, rotate, flip, cut, copy...)",
                            "CTRL + click (lasso) - Add to current selection",
                            "CTRL + click (magic wand) - Add / remove area from selection",
                            "SHIFT + click (magic wand) - Add all matching tiles in the map to the selection",
                            "Rectangle select: drag the selection border to resize it",
                            "ARROW RIGHT - Move to right map",
                            "ARROW LEFT - Move to left map",
                            "ARROW UP - Move to up map",
                            "ARROW DOWN - Move to down map"
