...
public class TilesetEditorDialog extends JDialog {
    ...
    public TilesetEditorDialog(Window owner) {
        ...
        ((JPanel) jbAddTile.getParent()).add(jbMoveToFolder, "cell 4 0");
        ...
        ((JPanel) jbAddTile.getParent()).add(jbCreateSmartDrawing, "cell 5 0");
    }
    ...
    private void createSmartDrawingFromFolderSelection() {
        ...
        Tile first = handler.getTileset().get(indices.get(0));
        String folderPath = null;
        for (String candidate : first.getPaletteFolderSlots().keySet()) {
            boolean shared = true;
            for (int index : indices) {
                if (!handler.getTileset().get(index).isInPaletteFolder(candidate)) {
                    shared = false;
                    break;
                }
            }
        ...
        smartGridEditableDisplay.getSmartGridArray().add(grid);
        handler.setSmartGridIndexSelected(smartGridEditableDisplay.getSmartGridArray().size() - 1);
